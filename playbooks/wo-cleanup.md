...
- `BalanceOwed__c` within ±$0.05 (`> -0.05 AND < 0.05`) — a tax-rounding tolerance so done WOs sitting at a ±$0.01 residual close instead of lingering indefinitely; was strictly `= 0` before
